...
var brokersStartTimeout string

var brokersStartCmd = &cobra.Command{
	Use:   "start",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if err := brokers.Start(c, args[0], brokersStartTimeout); err != nil {
...
func init() {
	brokersCmd.AddCommand(brokersStartCmd)

	brokersStartCmd.PersistentFlags().StringVarP(&brokersStartTimeout, "timeout", "", "", "Timeout (30s, 1m, 1h). 0s - no timeout")
}
